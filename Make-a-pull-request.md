...
* After a while, check your pull request to see whether the CI checks have passed. If not, follow our instructions to [[diagnose PR failures|Diagnose-PR-failures]].
...
(See [[Diagnose PR failures|Diagnose-PR-failures]] for some suggestions on what to do if you run into issues.)
